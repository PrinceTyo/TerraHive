...
export default function About() {
  return (
    <section
      className="px-4 py-20 md:px-20 bg-linear-to-b from-gray-100 to-gray-50 flex flex-col-reverse lg:flex-row lg:items-start lg:justify-between gap-10 lg:gap-6"
      id="about"
    >
      <div className="relative lg:w-1/2">
        <img
          ...
          alt="About Image"
          className="absolute -bottom-5 lg:bottom-10 right-6 w-50 h-40 object-cover rounded-xl z-10"
        />
        <img
          src="https://i.pinimg.com/736x/38/34/a6/3834a6fbc01211938cd831b0bd868068.jpg"
          alt="About Image"
          className="w-full lg:w-126 h-116 object-cover rounded-3xl"
          style={{
      ...
      <div className="lg:w-2/3">
        <div>
          <p className="text-primary tracking-widest text-lg lg:text-lg">
            ― ABOUT
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-2 gap-4 py-6">
